...
public class TeaCirclePostController {
    ...
    public Result<TeaPostVO> addPost(@Valid @RequestBody TeaPostAddRequest request) {
    ...
    public Result<PageResult<TeaPostVO>> explore(@RequestParam(defaultValue = "1") int page,
        ...
        Long userId = SecurityUtils.getCurrentUserId(); // 可选登录
    ...
    public Result<TeaCommentVO> addComment(@PathVariable Long id, @Valid @RequestBody TeaCommentAddRequest request) {
        Long userId = SecurityUtils.getCurrentUserId();
